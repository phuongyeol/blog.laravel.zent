...
<head>
	<meta charset="UTF-8">
	<title>Blog - ZonZon</title>
	<!-- Latest compiled and minified CSS & JS -->
	<meta name="viewport" content="witdh=device-with, initial-scale=1.0">
	<link rel="shortcut icon" type="image/png" href="blog_assets/img/favicon.png"/>
	<!-- STYLES -->
...
<body>
    	...
    	<nav class="menu-desktop menu-sticky">
            ...
            <ul class="tada-menu">
                     <li><a href="#" class="active">HOME <i class="icon-arrow-down8"></i></a>
                        <ul class="submenu">
                        	<li><a href="{{ asset('home-1-column')}}">Home 1 Column</a></li>
                            <li><a href="{{ asset('home-1-column-with-sidebar')}}" class="active">Home 1 Column + Sidebar</a></li>                            
                            <li><a href="{{ asset('home-2-columns-with-sidebar')}}">Home 2 Columns + Sidebar</a></li>
                            <li><a href="{{asset('home-2-columns')}}">Home 2 Columns</a></li>
                            <li><a href="{{ asset('home-3-columns')}}">Home 3 Columns</a></li>                                                                      
                        </ul>
                    </li>
                    <li><a href="#">POSTS <i class="icon-arrow-down8"></i></a>
                        <ul class="submenu">
                            <li><a href="{{ asset('post-detail')}}">Post Detail</a></li>
                            <li><a href="{{ asset('post-list')}}">List Post</a></li>                            
    ...
    ****************************************************************** -->
	...
	<section class="tada-container content-posts">
        {{-- Phần nội dung mà trong các file .blade.php sẽ thay nội dung vào đây:  --}}
    	<!-- Kế thừa các file -->
        @yield('content')
